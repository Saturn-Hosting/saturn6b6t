<div id="header">
    <div id="headerbar">
        <a href="/status"><img id="headerstatus" src="/res/img/headerbar/status-ok.png"></a> <img
            id="headerfade_left" src="/res/img/headerbar/fade-left.png">
        <marquee truespeed scrolldelay="30" scrollamount="3" id="headernews">
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p>Welcome to Saturn's homepage</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p style="color: lime">Applications open</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p style="color: lime">New members sought</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p>discord.gg/ajm7CSRBZY</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p>Saturn self griefs own base</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
            <p>Join the discord now!</p>
            <img class="newssep" src="/res/img/headerbar/sep.png">
        </marquee>
    </div>
